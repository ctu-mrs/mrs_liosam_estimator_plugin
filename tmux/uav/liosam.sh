...
'
  'vio_imu' 'waitForTime; roslaunch mrs_serial vio_imu.launch
'
  'imu_filter' 'waitForTime; roslaunch vins_imu_filter filter_icm_42688.launch
'
...
'
  'AutoStart' "waitForControl; roslaunch mrs_uav_autostart automatic_start.launch
"
  'Roscore' 'roscore
'
